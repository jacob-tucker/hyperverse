    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="Tribes - Add a New Tribe" description="Add a new Tribe. ** 'Recipient' MUST have a Tribes.Admin for the
                                                                                specified tenantID**" action="TribesAddTribe"
          method="post" fields="tenantOwner newTribeName">
          <account-widget field="tenantOwner" label="Tenant Address">
          </account-widget>
        ...
        <action-card title="Tribes - Join a Tribe" description="Join a Tribe and add the Tribe's resource to your Identity. 
                          ** 'Recipient' MUST have a Tribes.Package and Setup their Package**" action="TribesJoinTribe"
          method="post" fields="tenantOwner signer tribeName">
          <account-widget field="tenantOwner" label="Tenant Address">
          </account-widget>
        ...
        <action-card title="Tribes - Leave Your Tribe" description="Leave your current Tribe and remove the Tribe's resource from your Identity.
                                   ** 'Signer' MUST be a part of a Tribe already.**" action="TribesLeaveTribe" method="post"
