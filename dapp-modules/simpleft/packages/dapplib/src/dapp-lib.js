...
module.exports = class DappLib {
  ...
  static async SimpleFTUserSetup(data) {
  ...
  static async SimpleFTGiveAdministrator(data) {
  ...
  static async SimpleFTHasTenant(data) {
