...
module.exports = class DappLib {
  ...
  static async test(data) {
    ...
    let result = await Blockchain.get({
      ...
      'hyperverse_service_test', {
      path: { value: data.tenantID, type: t.PublicPath }
    }
    );
  ...
  static async nftMarketplaceInstance(data) {
  ...
  static async nftMarketplaceGetNFTCollection(data) {
    ...
    let result = await Blockchain.post({
      ...
      'nft_marketplace_get_nft_collection',
      {
  ...
  static async nftMarketplaceGiveMinter(data) {
  ...
  static async nftMarketplaceMintNFT(data) {
    ...
    let result = await Blockchain.post({
      ...
      'nft_marketplace_mint_nft',
      {
        recipient: { value: data.recipient, type: t.Address },
        morganNFTTenantAccount: { value: data.morganNFTTenantAccount, type: t.Address }
      }
    );
  ...
  static async nftMarketplaceHasNFTMarketplaceTenant(data) {
    ...
    let result = await Blockchain.get({
      ...
      'nft_marketplace_has_nft_marketplace_tenant',
      {
    ...
    return {
      ...
      label: 'Has NFT Marketplace Tennat',
      result: result.callData
    }
  }

  static async nftMarketplaceGetNFTIDs(data) {
  ...
  static async totalTenants(data) {
    ...
    let result = await Blockchain.get({
      ...
      'hyperverse_service_total_tenants'
    );
